...
<commentary>Since the user is asking for pattern analysis and code quality review, use the use_subagent tool to launch the pattern-recognition-specialist agent.</commentary>
</example>
<example>
