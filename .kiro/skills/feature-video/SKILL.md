...
the feature-video skill

# Record video for specific PR
the feature-video skill 847

# Record with custom base URL
the feature-video skill 847 http://localhost:5000

# Record for staging environment
the feature-video skill current https://staging.example.com
```
