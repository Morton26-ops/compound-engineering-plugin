...
# Validate JSON
cat .claude-plugin/marketplace.json | jq . > the dev skill/null && echo "✓ marketplace.json valid"
cat plugins/compound-engineering/.claude-plugin/plugin.json | jq . > the dev skill/null && echo "✓ plugin.json valid"
