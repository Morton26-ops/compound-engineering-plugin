...
```bash
# Get plugin version
cat ~/.kiro/plugins/installed_plugins.json 2>/dev/null | grep -A5 "compound-engineering" | head -10 || echo "Plugin info not found"
...
---
*Reported via the report-bug skill command*
```
