...
|-------------|----------|
| `app/views/users/*` | the users skill, the users skill/:id`, the users skill/new` |
| `app/controllers/settings_controller.rb` | the settings skill |
...
Then run the test-browser skill again.
```
...
| Route | Status | Notes |
|-------|--------|-------|
| the users skill | Pass | |
| the settings skill | Pass | |
| the dashboard skill | Fail | Console error: [msg] |
| the checkout skill | Skip | Requires payment credentials |
...
### Failures: [count]
- the dashboard skill - [issue description]
...
the test-browser skill

# Test specific PR
the test-browser skill 847

# Test specific branch
the test-browser skill feature/new-dashboard
```
