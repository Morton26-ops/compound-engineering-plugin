...
Then restart Claude Code and run the xcode-test skill again.
```
...
the xcode-test skill

# Test specific scheme
the xcode-test skill MyApp-Debug

# Test after making changes
the xcode-test skill current
```

## Integration with the workflows-review skill

When reviewing PRs that touch iOS code, the the workflows-review skill command can spawn this as a subagent:

```
Use the use_subagent tool to delegate to the general-purpose agent: "Run the xcode-test skill for scheme [name]. Build, install on simulator, test key screens, check for crashes."
```
