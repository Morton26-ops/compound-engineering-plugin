...
- the workflows-plan skill - Create implementation plans
- the workflows-review skill - Run comprehensive code reviews
- the workflows-work skill - Execute work items systematically
- the workflows-compound skill - Document solved problems

**Why `workflows:`?** Claude Code has built-in the plan skill and the review skill commands. Using `name: workflows:plan` in frontmatter creates a unique the workflows-plan skill command with no collision.
