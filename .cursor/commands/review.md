...
- Use standard template from `.cursor/skills/file-todos/assets/todo-template.md`
...
2. Use file-todos skill for structured todo management:
   ...
   - Template location: `.cursor/skills/file-todos/assets/todo-template.md`
...
5. Follow template structure from file-todos skill: `.cursor/skills/file-todos/assets/todo-template.md`
