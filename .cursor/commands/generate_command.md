...
Create a new slash command in `.cursor/commands/` for the requested task.
...
1. **Create the file** at `.cursor/commands/[name].md` (subdirectories like `workflows/` supported)
